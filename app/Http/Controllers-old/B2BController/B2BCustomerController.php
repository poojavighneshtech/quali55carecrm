...
class B2BCustomerController extends Controller
{
    ...
    {
        //View All Agents
        $b2bcustomers = DB::table('user_details')->where('flag','Active')->paginate(10);
        return view('B2BCust.b2bcustomers',compact('b2bcustomers'));
    }
    ...
    {
        //
        $user = DB::table('user_details')->where('type','b2buser')->where('flag','Active')->where('id',$id)->get()->toArray();
        $cities = DB::table('cities')->get()->toArray();
        $states = DB::table('states')->get()->toArray();
        $countries = DB::table('countries')->get()->toArray();
