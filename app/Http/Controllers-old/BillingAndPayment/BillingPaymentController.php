...
class BillingPaymentController extends Controller
{
    ...
    public function PaymentRecieved(Request $request,$order_id)
    {
        ...
        return redirect()->to('pending_payments')->with('message','Online Payment Done sucessfully');
    ...
    public function pendingPaymentOrder(Request $request)
    {
        ...
        return view('BillingAndPayment/pending_payments',compact('non_settled_orders','filter_arr','count_array','amount_array','get_lead_owner','all_delivery_boys','bankCustomerDetails','cities','orderClosedReason','leadsource','products','prodcountrent','prodcountrenewal','categories'));
    }
