...
class LeadController_test extends Controller
{
   ...
   //   dd($whereCondition);
      ...
      else
      {
         ...
         return view('leads/view_all_leads_test',compact('json_decode_all_leads','get_lead_sources','get_customer_location','get_lead_owners','filter_arr','filter_collapse_cookie','cities','lead_cancellation_reason','get_all_leads'));
      }
	}
