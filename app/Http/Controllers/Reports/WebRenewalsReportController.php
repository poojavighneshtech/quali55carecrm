...
class WebRenewalsReportController extends Controller
{
   ...
   public function WebRenewals_report(Request $request)
   {
      ...
      return view('Reports/WebRenewals_report',compact('report_d'));
   }
}
