    ...
    <div class="modal fade " id="updateCollectionOrder" tabindex="-1" role="dialog" aria-labelledby="updateCollectionOrder" aria-hidden="true">
        ...
        <div class="modal fade" id="updateOrder" tabindex="-1" role="dialog" aria-labelledby="updateOrder" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="updateOrder">update Order</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        <div class="modal-body">
                            ...
                            {{-- <input type="hidden" name="hidden_order_id" id="hidden_order_id"> --}}
                            <div class="card" id="labourChargesCard" style="display: block">
                        ...
                        <div class="order-product-details">
                            <div class="row form-group">
                                <div class="col-md-6">
                                    ...
                                    <select class="select ad-product selectpicker form-control form-control-sm" title="Select Product" data-live-search="true" data-size="5" name="inorderproductdm" id="inorderproductdm">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm" name="adjusted_deposit_dm" id="adjusted_deposit_dm" value="0">
                                </div>
                            </div>
                            ...
                            table += '<table class="table" id="order_details_table">';
                                ...
                                for (let i = 0; i < details_count; i++)
                                {
                                    ...
                                    if(data[i].sale_rental == 'Rental'){
                                        ...
                                        table +='<td data-label="Months">'+data[i].months+'</td>';
