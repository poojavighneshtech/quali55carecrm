...
<body id="page-top">	
                ...
                <div class="card">
                    ...
                    {{-- <form action="{{url('/')}}/raise_complaint" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{url('/')}}/get_cust_or_complaint" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" placeholder="Search Customer.." name="customer_val" id="txt_search_customer">
                                            </div>
                                            <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <input type="hidden" name="hidden_customer_id" id="hidden_customer_id" value="{{$customer_details[0]['cust_id']}}">
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="row">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="card">
                                                        ...
                                                        <table class="table table-striped" id="records">
                                                            ...
                                                            <tbody>
                                                                @php
                                                                    $srno = 1;
                                                                @endphp
                                                                @foreach($complaint_details as $key=>$cmp_details)
                                                                    <tr>
                                                                        <td>{{$srno}}</td>
                                                                        <td>{{$cmp_details['complaint_date']}}</td>
                                                                        <td>{{$cmp_details['product_name']}}</td>
                                                                        <td>{{$cmp_details['vendor_name']}}</td>
                                                                        <td>{{$cmp_details['delivered_by']}}</td>
                                                                        <td>{{$cmp_details['lead_owner']}}</td>
                                                                        <td>{{$cmp_details['created_by']}}</td>
                                                                        <td>{{$cmp_details['status']}}</td>
                                                                    </tr>
                                                                    @php
                                                                        $srno++;
                                                                    @endphp
                                                    ...
                                                    <textarea class="form-control" name="" id="" cols="30" rows="10" disabled>{{$cmp_details['remarks']}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $('input[type=radio][name=radio_search_customer]').on('change', function(){
            ...
            {
                $('#txt_search_customer').attr("placeholder", "Complaint ID..");
                $('#btn_search_customer').val('complaint_searched');
            }
            else if(radio_val=='customer_name_no')
            {
                $('#txt_search_customer').attr("placeholder", "Search Customer..");
                $('#btn_search_customer').val('customer_searched');
            }
        });
