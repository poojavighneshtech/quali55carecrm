...
<html lang="en">
    ...
    <head>
        ...
        <title>Delivery : All Delivery</title>
        @section('styles')
        <style>
...
<body id="page-top">	
        ...
        @section('breadcrumb_item')
            <li class="breadcrumb-item active" aria-content="page">All Deliveries</li>
        @endsection
            <div class="container">
                @section('content')
                <div class="row">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr class="row_scroll <?php if($order_detail['status'] == 'Delivered'){echo "table-success";}elseif($order_detail['status'] == 'Picked Up'){echo "table-info";}elseif($order_detail['status'] == 'Collected'){echo "table-warning";}?>">
                                            ...
                                            <td>{{ $order_detail['patient_name']}}</td>
