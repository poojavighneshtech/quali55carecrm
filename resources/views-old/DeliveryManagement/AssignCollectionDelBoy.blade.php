                    ...
                    {{-- <input type="hidden" name="lead_id" value="{{$order_details[0]['lead_id']}}"> --}}
                        ...
                        <div class="container-fluid ">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="selectpicker helpers form-control" name="helpers[]" id="helpers" data-live-search="true" title="Select Helpers" multiple="multiple" required>
                                ...
                                <div class="table table-responsive jim-table-responsive">
                                    <table id="DataTable" class="table table-bordered" width="100%">
                                        ...
                                        <tbody class="table-body">
                                                ...
                                                @foreach ($product_details as $product_inf) 
                                                    <tr id="{{$count}}">
                                                        ...
                                                        <td data-label="Product Name">
                                                            ...
                                                            <input type="hidden" name="start_date[]" id="start_date" value="{{$product_inf['start_date']}}">
                                                            <input type="hidden" name="end_date[]" id="end_date" value="{{$product_inf['end_date']}}">
                                                            {{-- <input type="hidden" name="lead_id[]" id="lead_id" value="{{$product_inf['lead_id']}}"> --}}
                                                        </td>
                                                        <td data-label="Quantity">{{$product_inf['product_qty']}}</td>
                                                        <td data-label="Start Date">{{$product_inf['start_date']}}</td>
                                                        <td data-label="End Date">{{$product_inf['end_date']}}</td>
                                                ...
                                                @endforeach
                                                <tr>
                                                    <td colspan="7" class="text-right" data-label="Total Collect">Total : 
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8 text-left">
                                    <input type="radio" name="invoice_type" id="softcopy" value="NO" checked="checked"> <label for="softcopy" class="form-label">Softcopy</label>
                                    <input type="radio" name="invoice_type" id="hardcopy" value="YES"> <label for="hardcopy" class="form-label">Hardcopy</label>
                                </div>
                            </div>
