                                                                            ...
                                                                            <select class="selectpicker show-tick Drop_at" name="Drop_at[{{$count}}][id]" id="Drop_at{{$count}}" title="Drop Location" data-live-search="true" required>
                                                                                <optgroup  label="Pools">
                                                                                    @foreach($pool_details as $pool)
                                                                                        <option value="{{$pool['id']}}" @if($product_inf['pool_id']==$pool['id'] && $product_inf['drop_location']=='Pools'){{"selected"}}@endif>{{$pool['registered_name']}}-{{$pool['wh_name']}},{{$pool['wh_city']}}</option>
                                                                                    @endforeach
                                                                                </optgroup>
                                                                                <optgroup label="Vendor" >
                                                                                    <option value="{{$product_inf['vendor_id']}}"  @if($product_inf['drop_id']==$product_inf['vendor_id'] && $product_inf['drop_location']=='Vendor'){{"selected"}}@endif>{{$product_inf['vendor_name']}}</option>
                                                                                </optgroup>
                                                                            </select>
                                                                            <input type="hidden" name="Drop_at[{{$count}}][type]" id="drop_type{{$count}}" value="@if($product_inf['drop_location']=='Pools'){{"Pools"}}@elseif($product_inf['drop_location']=='Vendor'){{"Vendor"}}@endif">
