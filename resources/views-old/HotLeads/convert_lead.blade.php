    ...
    @section('content')
        <div class="card">
            ...
            <div class="card-body"><!--style="min-height: 0; max-height: 5; overflow-y: scroll;"-->
                <form class="form doublePost" method="POST" action="<?php echo url('/');?>/update_hot_lead" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="row form-group">
                        <div class="col-md-4">                                            
                            <label for="cust_name">Converted Date</label>
                            <input type="hidden" name="converted_at" value="">
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" placeholder="Select Location" list="city" id="location" name="location" value="" required>
                            <datalist id="city">
                        ...
                        <div class="col-md-8">
                            <div class="btn-group btn-group-toggle btn-block btn-sm" data-toggle="buttons">
                                <label class="btn btn-outline-success btn-sm active">
                                    <input type="radio" name="customer_type" id="radio_individual" value="Individual" checked> Individual
                                </label>
                    ...
                    <div class="row form-group corporation" style="display:none;">
                        <div class="col-md-4">
                            <label for="customer_type">Corporation: </label>
                        </div>
                        <div class="col-md-8">
                            <select class="select selectpicker form-control form-control-sm" title="Select Corporation" name="corp_master" id="corp_master">
                    ...
                    <div id="corporate_contacts" class="row form-group" style="display:none;">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="contact_person_1_name" name="contact_person_1_name" placeholder="First Contact Person Name">
                        </div>
                        <div class="col-md-3">
                            <label for="contact_person_1_no">Contact Number</label>
                            <input type="text" class="form-control" id="contact_person_1_no" name="contact_person_1_no" placeholder="First Contact Person Number" oninput="numberOnly(this.id);" maxlength="10">
                        </div>
                        <div class="col-md-3">
                            <label for="contact_person_2_name">Corporate Contact Person 2</label>
                            <input type="text" class="form-control" id="contact_person_2_name" name="contact_person_2_name" placeholder="Second Contact Person Name">
                        </div>
                        <div class="col-md-3">
                            <label for="contact_person_2_no">Contact Number</label>
                            <input type="text" class="form-control" id="contact_person_2_no" name="contact_person_2_no" placeholder="Second Contact Person Number" oninput="numberOnly(this.id);" maxlength="10">
                        </div>
                        <hr>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <select class="select selectpicker" title="Select Lead Source" data-size="5" name="lead_source" id="lead_source" required>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="" class="rounded " id="output"  alt="" width="600" height="600" />
                </div>
    ...
    <script>
        ...
        $('input[name="customer_type"]').change(function(){
            ...
            if(customer_type == "Individual")
            {
                ...
                $(".corporation").hide();
                $("#corp_master").removeAttr('required');
            }
