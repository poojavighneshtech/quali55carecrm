                                    ...
                                    @if(isset($jd_lead_details))
                                        ...
                                        @foreach ($jd_lead_details as $lead_details)
                                            ...
                                            <tr data-count="{{$count}}">
                                                ...
                                                <td>{{$lead_details['status']}}</td>
                                                <td>{{$lead_details['remark']}}</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </tbody>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#filter').on("change",function(){
            ...
            var url = "<?php echo url('/');?>/filterJDLeadsClosed/"+dataString;
            window.location.assign(url);
        })
    });
</script>
