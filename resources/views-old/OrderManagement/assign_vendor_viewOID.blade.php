                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-md-8">
                                            ...
                                            <input type="hidden" name="customer_gender" value="{{$lead_details[0]['cust_gender']}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6 col-md-4 ">
                                                ...
                                                if($sale_rental[$i] == "Rental")
                                                {
                                                    for($j=0; $j <$equipment_quantity[$i]; $j++)
                                                    {
                                                        ...
                                                        <tr class="rows @if($sale_rental[$i] == "Sale"){{'table-info'}}@elseif($sale_rental[$i] == "Rental"){{"table-success"}}@endif" data-count="{{$count}}" >
                                                            ...
                                                            <td id='select_batch{{$i}}' class="text-wrap" data-label="Batch">
                                                                @if($sale_rental[$i] == "Rental")
                                                                    @if($default_vdr_details[$i]!="Not Found")
                                                                        <select class="select selectpicker form-control" width="fit" title="Select Batch" name="batches[]" id="def_batches{{$count}}" data-live-search="true" width="100%" required="true">
                                                                            <option value="{{$default_vdr_details[$i][0]->vendor_product_id}}" selected>{{$default_vdr_details[$i][0]->batch}}- {{$default_vdr_details[$i][0]->product_rent}}</option>
                                                                        </select>
                                                                    @else
                                                                        <select class="select selectpicker form-control" width="fit" title="Select Batch" name="batches[]" id="batches{{$count}}" data-live-search="true" width="100%" required="true">
                                                            ...
                                                            <td id='select_inventory{{$i}}' class="text-wrap" data-label="Inventory">
                                                                @if($sale_rental[$i] == "Rental")
                                                                    @if($default_vdr_details[$i]!="Not Found")
                                                                        <select class="select selectpicker form-control" data-dropup-auto="false" data-size="3" width="fit" title="Select Inventory" name="inventories[]" id="def_inventories{{$count}}" data-live-search="true" width="100%" required="true">
                                                                            <option value="{{$default_vdr_details[$i][0]->vendor_product_details_id}}" selected>{{$default_vdr_details[$i][0]->inventory_id}}</option>
                                                                        </select>
                                                                    @else
                                                                        <select class="select selectpicker form-control" data-dropup-auto="false" data-size="3" width="fit" title="Select Inventory" name="inventories[]" id="inventories{{$count}}" data-live-search="true" width="100%" required="true">
                                                ...
                                                else if($sale_rental[$i] == "Sale")
                                                {
                                                        ...
                                                        <tr class="rows @if($sale_rental[$i] == "Sale"){{'table-info'}}@elseif($sale_rental[$i] == "Rental"){{"table-success"}}@endif" data-count="{{$count}}" >
                                                            ...
                                                            <td data-label="Vendor" class="text-wrap" id='select_vendor{{$i}}'>
                                                                <select class="select selectpicker form-control" width="fit" title="Select Vendor" name="vendors[]" id="vendors{{$count}}" data-live-search="true" width="100%" required="true">
                                                                    <option value="" disabled>No Vendors Found</option>
                                                                </select>
                                                            </td>
                                                            <td data-label="Warehouse" class="text-wrap" id='select_warehouse{{$i}}'>
                                                                <select class="select selectpicker form-control" width="fit" title="Select Warehouse" name="warehouses[]" id="warehouses{{$count}}" data-live-search="true" width="100%" required="true">
                                                                    {{-- <option value="" disabled>Select Vendor First</option> --}}
                                                                    <optgroup label="Virtual Warehouse">
                                                                        <option value="" disabled>No Warehouse Found</option>
                                                                    </optgroup>
                                                            ...
                                                            <td data-label="Brand" class="text-wrap" id='select_brand{{$i}}'>
                                                                <select class="select selectpicker form-control" width="fit" title="Select Brand" name="brands[]" id="brands{{$count}}" data-live-search="true" width="100%" required="true">
                                                                    <option value="" disabled>Select Warehouse First</option>
                                                                </select>
                                                            </td>
                                                            <td data-label="Batch" class="text-wrap" id='select_batch{{$i}}'>
                                                                @if($sale_rental[$i] == "Rental")
                                                                <select class="select selectpicker form-control" width="fit" title="Select Batch" name="batches[]" id="batches{{$count}}" data-live-search="true" width="100%" required="true">
                                                                    <option value="" disabled>Select Brand First</option>
                                                                </select>
                                                            ...
                                                            <td data-label="Inventory" class="text-wrap" id='select_inventory{{$i}}'>
                                                                @if($sale_rental[$i] == "Rental")
                                                                <select class="select selectpicker form-control" width="fit" title="Select Inventory" name="inventories[]" id="inventories{{$count}}" data-live-search="true" width="100%" required="true">
                                                                    <option value="" disabled>Select Batch First</option>
                                                                </select>
                                                                @else
                                                                    <input type="hidden" name="inventories[]" id="inventories{{$count}}" value="0">
