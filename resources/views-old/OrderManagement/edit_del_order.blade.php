...
<body id="page-top">	
    ...
    @section('content')
                        ...
                        <div class="list-group-item list-group-item-action flex-column align-items-start @if($value->status == 'Cancel'){{'overlay-card'}}@endif">
                            ...
                            <div class="row mb-1">
                                ...
                                @if($value->offered_deposit != $value->product_deposite)
                                    <div class="col-auto">
                                        <b><span>Offered Deposit : </span></b><span id="offered_deposit{{$key}}">{{$value->offered_rent}}</span>
                                    </div>
                                @endif
                                <div class="col-auto">
                                    <b><span>Deposit : </span></b><span id="product_deposite{{$key}}">{{$value->offered_deposit}}</span>
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{-- <select data-size="5" class="selectpicker outline-primary form-control" id="product_name" width="100%" readonly="true">
                                ...
                                <div class="col-md-6">
                                    <span>Product Deposite : </span>
                                    <input type="number" class="form-control" name="update_product_deposite" id="update_product_deposite" @if(!in_array(session('user_id'),[14,97,19])){{"disabled"}}@endif>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <button type="submit" class="btn btn-primary form-control" id="edit_vendor" @if(!in_array(session('user_id'),[14,97,19])){{"disabled"}}@endif>Edit Vendor</button>
                                    <button type="submit" class="btn btn-primary form-control" id="undo_changes" style="display: none;" @if(!in_array(session('user_id'),[14,97,19])){{"disabled"}}@endif>Reset</button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <span >Vendor : </span>
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Vendor" data-live-search="true" name="update_select_vendor" id="update_select_vendor" width="100%">
                                        <option value="No">No Vendor Found</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <span >Warehouse : </span>
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Warehouse" data-live-search="true" name="update_select_warehouse" id="update_select_warehouse" width="100%" onchange='addWarehouseBrand("update",$(this).val(),"warehouse")'>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Brand" data-live-search="true" name="update_select_brand" id="update_select_brand" width="100%" onchange='addWarehouseBrand("update",$(this).val(),"brand")'>
                                        <option value="No">Select Warehouse First</option>
                                    </select>
                                </div>
                                {{-- <div class="col-md-6" id="div_batch_rental">
                                    <span >Product Batch : </span>
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Batch" data-live-search="true" name="update_select_batch" id="update_select_batch" width="100%">
                                ...
                                <div class="col-md-6" id="div_sale_product_srno_wrnty">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <span>Serial No : </span>
                                            {{-- <span class="form-control" id="update_batch">Sr No</span> --}}
                                            <input type="text" class="form-control" name="update_sale_product_srno" id="update_sale_product_srno" @if(!in_array(session('user_id'),[14,97,19])){{"disabled"}}@endif>
                                        </div>
                                        <div class="col-md-6">
                                            <span>Warranty : </span>
                                            <input type="number" class="form-control" name="update_sale_product_warranty" id="update_sale_product_warranty" @if(!in_array(session('user_id'),[14,97,19])){{"disabled"}}@endif>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6" id="div_inventory_rental">
                                    <span >Inventory Id : </span>
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Inventory" data-live-search="true" name="update_select_inventory" id="update_select_inventory" width="100%">
                            ...
                            <div class="card-body">
                                <form action="{{route('edit-order-addr')}}" method="POST">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select data-size="5" class="selectpicker form-control" title="State*" name="state" id="state" data-live-search="true" required>                                                
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select data-size="5" class="selectpicker form-control" title="Country*" name="country" id="country" data-live-search="true" required>
                    ...
                    <form class="form" id="add_product_form">                        
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <span >Product Name : </span>
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Product" data-live-search="true" name="new_product_name" id="new_product_name" width="100%">
                                        @foreach($products as $key => $value)
                                            <option value="{{$value->id}}">{{$value->product_name}}</option>
                                        @endforeach
                                    </select>                                    
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <span >Vendor : </span>
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Vendor" data-live-search="true" name="new_select_vendor" id="new_select_vendor" width="100%">
                                        <option value="No" disabled>No Vendor Found</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <span >Warehouse : </span>
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Warehouse" data-live-search="true" name="new_select_warehouse" id="new_select_warehouse" width="100%">
                                        <option value="No" disabled>No Vendor Found</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <span >Product Brand : </span>
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Brand" data-live-search="true" name="new_select_brand" id="new_select_brand" width="100%">
                                ...
                                <div class="col-md-6" id="new_div_inventory_rental">
                                    <span >Inventory Id : </span>
                                    <select data-size="5" class="selectpicker outline-primary form-control" title="Select Inventory" data-live-search="true" name="new_select_inventory" id="new_select_inventory" width="100%">
                                        <option value="No">Select Batch First</option>
                                    </select>                                    
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="modal-body container-fluid">
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <select data-size="5" name="awb_warehouse" id="awb_warehouse" class="select selectpicker form-control form-control-sm" title="Warehouse" data-live-search="true" data-size="5">
                                    <option value="0" disabled>No Warehouse Found</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label for="awb_brand">Brand</label>
                                <select data-size="5" name="awb_brand" id="awb_brand" class="select selectpicker form-control form-control-sm" title="Brand" data-live-search="true" data-size="5">
        ...
        <div class="modal fade" id="modal_update_rental_to_sale" tabindex="-1" role="dialog" aria-labelledby="update_rental_to_sale" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form class="form" action="{{route('updateOrderProduct')}}" method="POST">
                        @csrf
                        <input type="hidden" name="request_type" id="request_type" value="convert-rent-to-sale">
                        <input type="hidden" name="rts_order_details_id" id="rts_order_details_id">
                        <div class="modal-header">
                        <h5 class="modal-title" id="update_rental_to_sale">Sale Rented Product</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <span id="rts_product_name">Product Name</span>
                                    (<span id="rts_inventory_id">MJEWH0423002</span>)
                                </div>
                            </div>
                            <div class="row form-group justify-content-center">
                                <div class="col-md-auto">
                                    <span id="rts_rent_txt">Rent</span>
                                </div>
                                <div class="col-md-auto">
                                    <span id="rts_rent">1000</span>
                                </div>
                                <div class="col-md-auto">
                                    <span id="rts_deposit_txt">Deposit</span>
                                </div>
                                <div class="col-md-auto">
                                    <span id="rts_deposit">1000</span>
                                </div>
                            </div>
                            <div class="row form-group justify-content-center">
                                <div class="col-md-4">
                                    <label for="rts_selling_rate">Selling Rate</label>
                                    <input type="number" name="rts_selling_rate" id="rts_selling_rate" class="form-control form-control-sm" value="0" min="0">
                                </div>
                                <div class="col-md-4">
                                    <label for="rts_adjust_rent">Adjust Rent</label>
                                    <input type="number" name="rts_adjust_rent" id="rts_adjust_rent" class="form-control form-control-sm" value="0" min="0">
                                </div>
                                <div class="col-md-4">
                                    <label for="rts_adjust_deposit">Adjust Deposit</label>
                                    <input type="number" name="rts_adjust_deposit" id="rts_adjust_deposit" class="form-control form-control-sm" value="0" min="0">
                                </div>
                            </div>
                            <div class="row form-group justify-content-center">
                                <div class="col-md-4">
                                    <label for="rts_date">Date</label>
                                    <input type="date" name="rts_date" id="rts_date" class="form-control form-control-sm" value="{{date('Y-m-d')}}">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" id="changetype" class="btn btn-outline-success">Sale Product</button>
                            <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(".sale-product").click(function(){
            let dataString = ({_token:"{{ csrf_token() }}",order_details_id:""+$(this).data("order_details_id"),request_type:"fetch-record"});
            $.ajax({
                type:"POST",
                ...
                success:function(resp){
                    let order_details = jQuery.parseJSON(resp);
                    console.log(order_details);
                    $("#rts_product_name").text(order_details.product_name);
                    $("#rts_inventory_id").text(order_details.unique_id);
                    $("#rts_rent").text(order_details.product_rent);
                    $("#rts_deposit").text(order_details.product_deposite);
                    $("#rts_order_details_id").val(order_details.id);
                    $("#modal_update_rental_to_sale").modal("show");
                },error:function(err){
        ...
        $("#rts_adjust_rent").on("input",function(){
            ...
            if(parseInt($(this).val()) > parseInt($("#rts_rent").text())){
                $(this).val($("#rts_rent").text());
                alert("Adjust Rent Amount Should be less than or equal to: "+$("#rts_rent").text());
            }
        });
        // Deposit
        $("#rts_adjust_deposit").on("input",function(){
            console.log($(this).val());
            if(parseInt($(this).val()) > parseInt($("#rts_deposit").text())){
                $(this).val($("#rts_deposit").text());
                alert("Adjust Deposit Amount Should be less than or equal to: "+$("#rts_deposit").text());
            }
        });
    </script>
    <script>
                ...
                $.ajax({
                    ...
                    success:function(resp){
                        ...
                        if(resp['status'] == 'exists'){
                            ...
                            $("#"+count+"_select_vendor").change();
                            setTimeout( function()
                            {
                                $("#"+count+"_select_warehouse").selectpicker("refresh");
                                $("#"+count+"_select_warehouse").val(warehouse_id);
                                $("#"+count+"_select_warehouse").selectpicker("refresh");
                                $("#"+count+"_select_warehouse").change();
                                setTimeout( function()
                                {
                                    $("#"+count+"_select_brand").selectpicker("refresh");
                                    $("#"+count+"_select_brand").val(brand_id);
                                    $("#"+count+"_select_brand").selectpicker("refresh");
                                    $("#"+count+"_select_brand").change();
        ...
        function addWarehouseBrand(count,value,type){
            if(value == 'Add'){
                ...
                let productid = $("#hidden_product_id").val();
                let vendorid = $("#"+count+"_select_vendor").val();
                if(type == 'warehouse' || type == 'brand'){
                    ...
                    $.ajax({
                        ...
                        success: function (data)
                        {
                            ...
                            $("#awb_vendorname").val($("#"+count+"_select_vendor"+" option:selected").text());
                            $("#awb_vendorname_hidden").val($("#"+count+"_select_vendor").val());
                            $("#awb_productid_hidden").val($("#hidden_product_id").val());
                            ...
                            if(type=="brand")
                            {
                                console.log($("#"+count+"_select_warehouse").val());
                                $('#awb_warehouse').val($("#"+count+"_select_warehouse").val());
    ...
    <script>
        ...
        $(document).ready(function(){
                ...
                if($("#hidden_edit_vendor").val() == "true")
                {
                    ...
                    $.ajax({
                        ...
                        success: function (data)
                        {
                            ...
                            let virtual_warehouse_details = data['virtual_warehouse_details'];
                            //------- Warehouse Selection --------//
                            $("#update_select_warehouse")
                                .find("option")
                                .remove()
                                .end();
                            for(var j = 0; j < virtual_warehouse_details.length; j++)
                            {
                                // console.log(virtual_warehouse_details[j].warehouse_id);
                                $("#update_select_warehouse").find('optgroup[label="Virtual Warehouse"]').append("<option value='"+virtual_warehouse_details[j].warehouse_id+"'>"+virtual_warehouse_details[j].wh_name+", "+virtual_warehouse_details[j].wh_area+", "+virtual_warehouse_details[j].wh_city+"</option>");

                            }
                            $("#update_select_warehouse").find('optgroup[label="Vendor Warehouse"]').append("<option value='Add'>Add New</option>");
                            for(var j = 0; j < warehouse_details.length; j++)
                            {
                                // console.log(warehouse_details[j].warehouse_id);
                                $("#update_select_warehouse").find('optgroup[label="Vendor Warehouse"]').append("<option value='"+warehouse_details[j].warehouse_id+"'>"+warehouse_details[j].wh_name+", "+warehouse_details[j].wh_area+", "+warehouse_details[j].wh_city+"</option>");
                        ...
                        $.ajax({
                            ...
                            success: function (data)
                            {
                                ...
                                $("#update_select_brand")
                                    ...
                                    .remove()
                                    .end();
                                $("#update_select_brand").append("<option value='Add'>Add New</option>");
            ...
            $('#update_select_brand').on('change', function(){
                ...
                if(brand_id != 'Add'){
                    if($("#hidden_edit_vendor").val() == "true")
                    {
                        $("#update_select_inventory").find("option").remove().end();
                            if($("#update_select_vendor").val() == 17 || $('option:selected', $("#update_select_warehouse")).parent('optgroup').prop('label') == 'Virtual Warehouse'){
                                let dataString = ({_token:"{{ csrf_token() }}",vendor_id:""+vendor_id,warehouse_id:""+warehouse_id,brand_id:""+brand_id,product_id:""+product_id,product_type:""+product_type,request_type:"fetch-inventory"});
                                $.ajax({
                                    type: "POST",
                                    url: "{{url('/')}}/updateOrderProduct",
                                    data: dataString,
                                ...
                                $('#update_select_inventory').selectpicker('refresh');
                                $("#update_select_inventory").append("<option value='AG' selected>Auto Generated</option>");
                                $('#update_select_inventory').selectpicker('refresh');
                            }
                ...
                $.ajax({
                    ...
                    success: function (data)
                    {
                        ...
                        $("#new_select_warehouse")
                            ...
                            .remove()
                            .end();
                        $("#new_select_warehouse").append("<option value='Add'>Add New</option>");
                        for(var j = 0; j < warehouse_details.length; j++)
                        {
                            // console.log(warehouse_details[j].warehouse_id);
                ...
                $.ajax({
                    ...
                    success: function (data)
                    {
                        ...
                        $("#new_select_brand")
                            ...
                            .remove()
                            .end();
                        $("#new_select_brand").append("<option value='Add'>Add New</option>");
                        for(var j = 0; j < brand_details.length; j++)
                        {
                            // console.log(warehouse_details[j].warehouse_id);
        ...
        function editProduct_fetch_detailsExists(id) 
        {
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    ...
                    $("#update_sale_product_srno").val(order_details[0].serial_no);
                    $("#update_sale_product_warranty").val(order_details[0].warranty);
                    let currentDate = new Date().toJSON().slice(0, 10);
                    if(order_details[0].creation_date == currentDate){
                        $("#edit_vendor").removeAttr('disabled');
                        $("#undo_changes").removeAttr('disabled');
                    }
                    //------- Vendor Selection --------//
                    ...
                    if(product_type == "Rental")
                    {
                        ...
                        $('#div_batch_sale').hide();
                        $('#div_sale_product_srno_wrnty').hide();
                        //------- Batch Selection --------//
                        $("#update_select_batch")
                            .find("option")
                            .remove()
                    ...
                    else if(product_type == "Sale")
                    {
                        ...
                        $('#div_sale_product_srno_wrnty').show();
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    ...
                    else
                    {
                        ...
                        $("#update_sale_product_srno").val(product_details[0].serial_no);
                        $("#update_sale_product_warranty").val(product_details[0].warranty);
                    }
                    ...
                    $("#update_select_warehouse")
                        ...
                        .remove()
                        .end();
                        $("#update_select_warehouse").find('optgroup[label="Vendor Warehouse"]').append("<option value='No' disabled>Select Vendor First</option>");
                    // for(var j = 0; j < warehouse_details.length; j++)
                    // {
                    //     // console.log(warehouse_details[j].warehouse_id);
                    //     $("#update_select_warehouse").find('optgroup[label="Vendor Warehouse"]').append("<option value='"+warehouse_details[j].warehouse_id+"'>"+warehouse_details[j].wh_name+", "+warehouse_details[j].wh_area+", "+warehouse_details[j].wh_city+"</option>");
        ...
        $("#update_product").click(function(){
            ...
            let sale_serial_no = $("#update_sale_product_srno").val();
            let sale_warranty = $("#update_sale_product_warranty").val();
