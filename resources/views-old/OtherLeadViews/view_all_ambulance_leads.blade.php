                            ...
                            <table class="table table-striped table-bordered table-responsive" id="records">
                                ...
                                <tbody>
                                    @foreach($get_all_leads as $key=> $all_leads) 
                                        <tr>
                                            <td>{{$key+1}}</td>
                                            <td>{{date('d-m-Y',strtotime($all_leads['created_at']))}}</td>
                                            <td>{{$all_leads['patient_name']}}</td>
                                            <td>{{$all_leads['contact_no']}}</td>
                                            <td>{{$all_leads['service_from']}}</td>
                                            <td>{{$all_leads['service_to']}}</td>
                                            <td>{{$all_leads['ambulance_type']}}</td>
