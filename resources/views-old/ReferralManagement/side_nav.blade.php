...
<body id="page-top">	
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo url('/');?>/viewAllLeadsD">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" id="leads" href="#" data-toggle="collapse" data-target="#collapseLeads"
                    aria-expanded="true" aria-controls="collapseLeads" onClick="myFunction(this.id);">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Leads Management</span>
                </a>
                <div id="collapseLeads" class="collapse leads" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                ...
                <a class="nav-link collapsed" id="expenses" href="#" data-toggle="collapse" data-target="#collapseLeads"
                    aria-expanded="true" aria-controls="collapseLeads" onClick="myFunction(this.id);">
                    <i class="fas fa-fw fa-cog"></i>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a href="http://intra.quali55care.com/testweb/presales/LeadManagement">User Management</a>&emsp;
                        <a href="http://intra.quali55care.com/testweb/presales/RefferalManagement">Refferal Management</a>&emsp;
                    </ul>
                    <ul class="navbar-nav ml-auto">
