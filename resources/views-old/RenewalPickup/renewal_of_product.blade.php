                            ...
                            <tbody>
                                ...
                                @foreach ($renew_info as $key=>$R_Info)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control offeredDiscount" name="offered_discount[{{$key}}]" id="offeredDiscount{{$key}}" min="0" data-id="{{$key}}">
                                        </td>
                                        <td>
                                            <span id="totalProductRentSpan{{$key}}">{{$R_Info['total_due_month_rent']}}</span>
                                            <input type="hidden" name="total_product_rent" id="total_product_mont_rent{{$key}}" value="{{$R_Info['total_due_month_rent']}}">
    ...
    @section('script')
        <script>
            ...
            $('.offeredDiscount, .monthCount').on('input',function(){
                ...
                // let total_amount = $("#totalProductRentInp"+data_id).val();
                // let discount = $(this).val();
                //let monthCount = $('#new_due_month_count')
                ...
                // let totalAmtCal = $('#total_amount_cal').val();

                // let totalProductRent = $('#totalProductRentInp'+data_id).val();
                // let offeredDiscount = $(this).val();
                // let totalProductDiscount = totalProductRent - offeredDiscount;
                // let totalAmountDiscount = totalAmtCal - offeredDiscount;
                
                // $('#total_amount_cal').val(totalAmountDiscount);
                // $('#totalProductRentSpan'+data_id).text(totalProductDiscount);
                // $('#totalAmountSpan').text(totalAmountDiscount);
            });
        </script>     
    @endsection
</html>
