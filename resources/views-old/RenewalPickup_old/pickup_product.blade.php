        ...
        <div class="leads">
            ...
            @endif 
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" method="post" action="{{url('/')}}/pickup_order">
                            {{csrf_field()}}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        @foreach ($pickup_info as $R_Info)
                                            <tr data-id="{{$i}}">
                                                <td>
                                                    ...
                                                    <input type="hidden" name="vendor_id[]" id="vendor_id" value="{{$R_Info['lead_id']}}">
                                                </td>
                                                <td>
                            ...
                            <br>
                                <center><button type="submit" class="btn btn-primary">Pickup Order</button></center>
                        </form>
                    </div>
                </div>
            </div>
