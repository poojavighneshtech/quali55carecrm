                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    @if($inv->details_id == null || in_array(session('user_id'),[14,97,19]))
                                        <button type="button" class="btn btn-sm btn-outline-primary edit-record" data-record_id = "{{$inv->id}}"><i class="fa fa-edit" aria-hidden="true"></i></button>
                                    @else
                                        <button type="button" class="btn btn-sm btn-outline-primary edit-img-record" data-record_id = "{{$inv->id}}"><i class="fa fa-edit" aria-hidden="true"></i></button>
                                    @endif
                            ...
                            <div class="container container-fluid">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        ...
                                        <select name="return_pickup_address" id="return_pickup_address" class="select selectpicker form-control">
