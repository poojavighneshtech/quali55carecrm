                        ...
                        <div class="col-md-12">
                            <div class="tab-content py-2">
                                ...
                                <div class="tab-pane" id="certificate">
                                    @if(isset($vendor_details[0]['gst_certificate']))
                                    ...
                                    @endif
                                    @if(isset($vendor_details[0]['shop_establishment_certificate']))
                                        <div class="form-group row">
                                    ...
                                    @endif
                                    @if(isset($vendor_details[0]['vendor_pan_card']))
                                        <div class="form-group row">
                                    ...
                                    @endif
                                    @if(isset($vendor_details[0]['vendor_aggreement']))
                                        <div class="form-group row">
                                    ...
                                    @endif
                                    {{-- @if($vendor_details[0]['type']!='personal')
                                        <div class="form-group row">
                                            <label class="col-lg-5 col-form-label form-control-label"><b>GST Certificate</b></label>
                                            <div class="col-lg-7">
                                                <a target="_blank" href="{{$vendor_details[0]['gst_certificate']}}" class="btn btn-primary" value="View Certificate">View Certificate</a>
