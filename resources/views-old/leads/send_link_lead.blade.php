    ...
    @section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="card">  
                ...
                <div class="card-body">
                    <form action="{{url('/')}}/send_link_lead" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <select class="select selectpicker form-control form-control-sm" title="Lead Source" name="lead_source" id="inpt_lead_source">
                ...
                <div class="table table-responsive jim-table-responsive p-2">
      ...
      @endif
        <script>
            ...
            function updateLink(id)
            {
                ...
                $('#select_product_required').val(product_arr_parse);
                $('#select_product_required').trigger('change');
                $("#inpt_lead_source").selectpicker('refresh');
            }
        </script>
