                                            ...
                                            <tbody class="table-body">
                                                ...
                                                ?>
                                                            <tr id="{{$count}}">
                                                                ...
                                                                <td width="-10%"><input type="date" class="form-control form-control-sm date" width="50px" name="DelDate[]" id="DelDate{{$count}}" value="<?php echo date('Y-m-d');?>"></td>
                                                                <td>{{$product['product_name']}}<input type="hidden" id="equipments{{$count}}" name="equipments[]" value="{{$product['id']}}"></td>
                                                                <td><input type="text" name="qty[]" id="qty{{$count}}" class="form-control form-control-sm" value="<?php echo "1";?>"></td>
                                                                <td>
                                                                ...
                                                                <td><div class="row"><div class="col-md-2"><input type="checkbox" name="same_as_deposite[]" id="same_as_deposite{{$count}}"></div><div class="col-md-10"><input type="text" name="offered_deposite[]" id="offered_deposite{{$count}}" class="form-control form-control-sm" value="" required></div></div></td>
                                                                <td><span id="rent_td{{$count}}">{{$product['product_rent']}}</span><input type="hidden" name="rent[]" id="rent{{$count}}" value="{{$product['product_rent']}}"></td>
                                                                {{-- <td>{{$product['product_rent']-($product['product_rent']*$product['min_rent_percentage'])/100}}</td> --}}
                                                                <td><div class="row"><div class="col-md-3"><input type="checkbox" name="same_as_rent[]" id="same_as_rent{{$count}}"></div><div class="col-md-9"><input type="text" class="form-control form-control-sm" id="offered_rent{{$count}}" name="offered_rent[]" value="" required></div></div><input type="hidden" name="min_rent[]" id="min_rent{{$count}}" value="{{$product['product_rent']-($product['product_rent']*$product['min_rent_percentage'])/100}}"></td>
                                                                <td><input type="text" class="form-control form-control-sm" id="transport{{$count}}" name="transport[]" value="" required></td>
