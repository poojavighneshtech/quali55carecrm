...
<head>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <img src="{{url('/')}}/assets/images/Failed.png" alt="">
                </div>
            </div>
            <div class="row">
                <div class="col justify-content-center text-center p-2">
                    <strong><p class="text-dark">If you have any queries or need any support please call to our support team at <a href="tel:{{$contact_no}}">{{$contact_no}}</a> / @if(isset($contact_no2))<a href="tel:{{$contact_no2}}">{{$contact_no2}}</a>@endif <span>({{$username}})</span> or checkout our website <a href="https://quali55care.com">Quali55care.com</a> </p></strong>
                </div>
            </div>
        </div>
    </body>
