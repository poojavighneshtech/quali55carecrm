...
@endif
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('agent-user-view-all')}}" method="get">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="{{route('agent-user-view-all')}}" class="btn btn-outline-secondary btn-sm btn-block">Clear</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <td data-label="Action" >
                                @if($value->flag=='Active')
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" width="100%">
                                        <a href="{{route('agent-user-view')}}/?id={{$value->id}}" title="View" class="dropdown-item btn btn-sm btn-outline-primary fas fa-eye text-primary"
                                            data-tooltip="tooltip" data-placement="bottom" title="View">
                                            <span>View</span></a>
                                        <a href="{{route('agent-user-view')}}/?id={{$value->id}}" title="Edit" class="dropdown-item btn btn-sm btn-outline-success fas fa-edit  text-success"
                                            data-tooltip="tooltip" data-placement="bottom" title="Edit">
                                            <span>Edit</span>
                                        </a>
                                        <a href="{{route('agent-user-delete')}}/?id={{$value->id}}" title="Delete" class="dropdown-item btn btn-sm btn-outline-danger fas fa-trash-alt text-danger"
    ...
    <div class="modal fade show" id="passwordChangeModal" tabindex="-1" role="dialog" aria-labelledby="passwordChangeModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{route('agent-user-password-change')}}" method="post">
                    @csrf
    ...
    <div class="modal fade show" id="activeUser" tabindex="-1" role="dialog" aria-labelledby="activeUserLabel" aria-hidden="true" >
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{route('agent-user-active')}}" method="post">
                    @csrf
                    <div class="modal-header">
