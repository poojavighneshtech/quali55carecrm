...
<script>
    ...
    $("#addItemBtn").on("click", function () {
        ...
        if (billingType === "Rental") {
            ...
            period = "-";   // <-- Sale me period nahi hoga
        }
        ...
        let total = (price * qty) + deposit + transport - discount;
        ...
        let row = `
            <tr>
                ...
                <td>${period}
                    <input type="hidden" name="items[period][]" value="${period}">
                </td>
                ...
                <td>₹${deposit.toLocaleString()}
                    <input type="hidden" name="items[deposit][]" value="${deposit}">
                </td>

                <td>₹${transport.toLocaleString()}
                    <input type="hidden" name="items[transport][]" value="${transport}">
                </td>

                <td>₹${discount.toLocaleString()}
