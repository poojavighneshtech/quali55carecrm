                ...
                <table class="table">
                    ...
                    @forelse($orders as $key=>$order)
                        <tr id="{{$order->order_id}}" data-order_type="Delivery">
                            ...
                            <td>{{$order->labour_charges}}</td>
                            <td>{{$order->order_expense}}</td>
                            <td>{{$order->vendor_charges}}</td>
                        </tr>
                        @foreach ($order->renewals as $ke=>$renewals)
                            ...
                            <tr id="{{$ke}}" data-order_type="Collection">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$renewals->first()->labour_charges}}</td>
                                <td>{{$renewals->first()->order_expense}}</td>
                                <td>{{$renewals->first()->vendor_charges}}</td>
                            </tr>
                        @endforeach
                        ...
                        @foreach ($order->pickups as $ke=>$pickups)
                            <tr id="{{$pickups->order_id}}" data-order_type="Pickup">
                                ...
                                <td>{{$pickups->labour_charges}}</td>
                                <td>{{$pickups->order_expense}}</td>
                                <td>{{$pickups->vendor_charges}}</td>
                            </tr>
                        @endforeach
                        <tr>
                           <th colspan="10"></th>
