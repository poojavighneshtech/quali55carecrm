                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <input type="checkbox" class="custom-control-input" id="sendwhatsapp" name="sendwhatsapp" value='sendw' checked>
                                                            <label class="custom-control-label" for="sendwhatsapp">Send Delivery Whatsapp</label>
                                                        </div>
