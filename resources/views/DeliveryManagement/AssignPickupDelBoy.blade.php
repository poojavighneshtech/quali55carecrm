                                        ...
                                        <div class="col-md-10 text-right">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-8 text-left">
                                                    ...
                                                    <input type="date" name="pickup_date" id="pickup_date" value="{{date('Y-m-d')}}">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-md-4">
                                                                ...
                                                                @foreach ($product_details as $product_inf) 
                                                                    <tr id="{{$count}}">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="hidden" name="vendor_product_rent[]" id="vendor_product_rent" value="{{$product_inf['vendor_rent']}}">
                                                                            <input type="hidden" name="vendor_rented_product_id[]" id="vendor_rented_product_id" value="{{$product_inf['rented_product_id']}}">
                                                                            ...
                                                                            <input type="hidden" name="pickup_date[]" id="pickup_date" value="{{$product_inf['pickup_date']}}">
                                                                        ...
                                                                        <td>
                                                                            {{-- <select class="selectpicker show-tick Drop_at" name="Drop_at[{{$count}}][id]" id="Drop_at{{$count}}" title="Drop Location" data-live-search="true" required>
                                                                                ...
                                                                                <input type="hidden" name="group_name[]" id="group_name{{$count}}" value="">
                                                                                <select class="selectpicker show-tick Drop_at" name="vendor_warehouse_id[]" data-id="{{$count}}" id="vendor_warehouse_id{{$count}}" title="Drop Location" data-live-search="true" required>
                                                                                    <optgroup label="Virtual Warehouse">
                                                                                        @foreach($product_inf['q5c_warehouse_details'] as $q5c_warehouse_detail)
                                                                                            <option value="{{$q5c_warehouse_detail['id']}}">{{$q5c_warehouse_detail['wh_name']}}-{{$q5c_warehouse_detail['wh_landmark']}},{{$q5c_warehouse_detail['wh_city']}}</option>
                                                                                        @endforeach
                                                                                    </optgroup>
                                                                                    <optgroup label="Vendor Warehouse">
                                                                                        @foreach($product_inf['vendor_warehouse_details'] as $vendor_warehouse_detail)
                                                                                            <option value="{{$vendor_warehouse_detail['id']}}">{{$vendor_warehouse_detail['wh_name']}}-{{$vendor_warehouse_detail['wh_landmark']}},{{$vendor_warehouse_detail['wh_city']}}</option>
                                                                                        @endforeach
                                                                                    </optgroup>
