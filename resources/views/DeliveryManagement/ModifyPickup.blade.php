                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="selectpicker helpers form-control" name="helpers[]" id="helpers" data-live-search="true" multiple="multiple">
                                        ...
                                        <table id="DataTable" class="table table-bordered" >
                                            ...
                                            <tbody class="table-body">
                                                    @php
                                                        ...
                                                        $srno=1;
                                                    @endphp
                                                    @foreach ($product_details as $key=>$product_inf) 
                                                        <tr id="{{$count}}">
                                                            <td data-label="Sr no">{{$srno++}}</td>
                                                            {{-- <td data-label="">{{$product_details[$i]['creation_date']}}</td> --}}
                                                            ...
                                                            <td data-label="Vendor">{{$product_inf['registered_name']}}</td>
                                                            <td data-label="Vendor">{{$product_inf['wh_name'].', '.$product_inf['wh_area'].', '.$product_inf['wh_city']}}</td>
                                                            <td data-label="Deposit">{{$product_inf['product_deposite']}}</td>
                                                                ...
                                                                {{-- Working Code --}}
                                                                    ...
                                                                    <select class="form-control form-control-sm selectpicker show-tick Drop_at" data-size="5" name="vendor_warehouse_id[]" data-id="{{$key}}" id="vendor_warehouse_id{{$key}}" title="Drop Location" data-live-search="true" required
                                                                        ...
                                                                        <optgroup label="Customer Location">
                                                                            @foreach($product_inf['customer_address'] as $cust_addr)
                                                                        ...
                                                                        <optgroup label="Virtual Warehouse">
                                                                            @foreach($product_inf['q5c_warehouse_details'] as $q5c_warehouse_detail)
                                                    ...
                                                    @endforeach
                                                    <tr>
                                                        <td colspan="6" class="text-right" data-label="total Deposit">Total :
                                                            {{$total_deposit}}
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-8 text-left">
                                        <input type="radio" name="invoice_type" id="softcopy" value="Softcopy" @if($order_details[0]['ReceiptToBeCarried']=='Softcopy' || $order_details[0]['ReceiptToBeCarried']=='NO'){{"checked"}} @endif> <label for="softcopy" class="form-label">Softcopy</label>
                                        <input type="radio" name="invoice_type" id="hardcopy" value="Hardcopy" @if($order_details[0]['ReceiptToBeCarried']=='hardcopy' || $order_details[0]['ReceiptToBeCarried']=='YES'){{"checked"}} @endif> <label for="hardcopy" class="form-label">Hardcopy</label>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-8 text-left">
                                        <input type="radio" name="travel" id="local" value="Local" checked> <label for="local" class="form-label">Local</label>
