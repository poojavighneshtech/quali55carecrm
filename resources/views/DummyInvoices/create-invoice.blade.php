                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="equip_tbody">
                                            <tr id="1">
                                                ...
                                                <td data-label="Billing Period"><input type="number" name="billingPeriod[]" id="billingPeriod1" class="form-control form-control-sm" value="1"></td>
                                                <td data-label="Billing Unit">
                                                    <select name="billingUnit[]" id="billingUnit1" class="select selectpicker form-control form-control-sm">
    ...
    <script>
        ...
        $("#add_product").click(function(){
            ...
            let row = '<tr id="'+id+'">';
                ...
                row += '</td>';
                row += '<td data-label="Billing Period"><input type="number" name="billingPeriod[]" id="billingPeriod'+id+'" class="form-control form-control-sm" value="1"></td>';
                row += '<td data-label="Billing Unit">';
                    row += '<select name="billingUnit[]" id="billingUnit'+id+'" class="select selectpicker form-control form-control-sm">';
