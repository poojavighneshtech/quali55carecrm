                    ...
                    {{ csrf_field() }}
                        <div class="card-body">
                            ...
                            <input type="hidden" name="lead_id" id="lead_id" value="<?php echo $lead_details[0]['id'];?>">
                                    ...
                                    <?php
                                        if($lead_details[0]['lead_status']!='Converted' && $lead_details[0]['lead_status'] != 'Work In Process' &&  $lead_details[0]['lead_status'] != 'Quali5Care' && $lead_details[0]['lead_status'] != 'Mobile Generated' && $lead_details[0]['lead_status'] != 'Order Generated' && $lead_details[0]['lead_status'] != 'Delivery In Progress' && $lead_details[0]['lead_status'] != 'Vendor Assigned')
                                        {
                                    ?>                                    
                                    <div class="row form-group">
                                        <div class="col-md-4">                                            
                                        ...
                                        <div class="col-md-8">
                                            <span><?php echo $lead_details[0]['remark'];?></span>
                                        </div>                                        
                                    </div>
                                    <?php
                                        }
