                    ...
                    <div class="col-md-8 ">
                        <div class="panel panel-primary">
                            <div class="panel-heading text-center">
                                <span><b>New JD Inquiry</b></span>
                            </div>
                            <br>
                            <div class="panel-body"><!--style="min-height: 0; max-height: 5; overflow-y: scroll;"-->
                                <form class="form" method="POST" action="{{url('/')}}/create_jd_lead/{{$jd_lead_details[0]['jd_leads_id']}}">
                                {{ csrf_field() }}
                                    ...
                                    <input type="hidden" name="remark" id="remark" value="{{$jd_lead_details[0]['remark']}}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div id="primary_contact" class="col-md-7">
                                            <input type="number" class="form-control" id="primary_contact_no"  name="primary_contact_no" value="{{$jd_lead_details[0]['mobile']}}" placeholder="Mobile Number (Primary)" max="9999999999" required="true">
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control"  id="cust_name" name="cust_name" placeholder="Customer Name" value="{{$jd_lead_details[0]['name']}}" required="true">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input class="form-control" list="city_list" id="location" title="Select Location" name="location" value="{{$jd_lead_details[0]['city']}}"  required>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-4">
                                            <label for="equipment_info">Required Equipment Info</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" name="equipment_info" id="equipment_info" value="{{$jd_lead_details[0]['category']}}" placeholder="" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="lead_source"  name="lead_source" placeholder="Lead Source (Google, JustDial, Marketing)" value="JustDial-National" required="true">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-4">
                                    ...
                                    <center>
                                        <button class="btn btn-primary" type="submit" id="submit" name="submit" value="submit1" >Qualify</button>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="area"  name="area" value="{{$jd_lead_details[0]['area']}}" placeholder="Area">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="pincode" name="pincode" maxlength="6" value="{{$jd_lead_details[0]['pincode']}}" placeholder="Pincode">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="email" class="form-control" id="email_id"  name="email" placeholder="Email" value="{{$jd_lead_details[0]['email']}}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" class="form-control" id="secondary_contact_no"  name="secondary_contact_no" max="9999999999" placeholder="Mobile Number (Secondary)">
                                        </div>
                                    </div>
                                    ...
                                    <center>
                                        <button class="btn btn-primary" type="submit" id="submit" name="submit" value="submit2" >Qualify</button>
