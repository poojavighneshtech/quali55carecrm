            ...
            <div class="container">  
                <div class="card">
                    <div class="card-header"  style="background-color: #4a6fdc; color: white;" >
                        <center>JD In Progress Leads</center>
                    </div> 
                    <div class="card-body">
                        <form class="form" method="post" action="{{url('/')}}/add_comment" >
                            {{csrf_field()}}
                        </form>
                        <div class="table">
                                    ...
                                    @if(isset($jd_lead_details))
                                        @foreach ($jd_lead_details as $lead_details)
                                            ...
                                            <tr data-count="{{$count}}">
                                                ...
                                                <td>
                                                    <a class="btn btn-outline-success btn-sm btn-block " href="{{url('/')}}/create_jd_lead/{{$lead_details['jd_leads_id']}}" role="button">Qualify</a>
                                                    <a class="btn btn-primary btn-sm btn-block " href="{{url('/')}}/in_process/{{$lead_details['jd_leads_id']}}/{{session('user_id')}}" role="button">Edit</a>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-sm" href="#my_modal" data-toggle="modal" data-book-id="{{$lead_details['remark']}}">...</a>
                                                    {{-- <span class="comment">
                                                        {{$lead_details['remark']}}
                                                    </span> --}}
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="">
                    ...
                    <div class="modal-footer">
                        <a class="btn btn-primary" id="add_comment" onclick="add_comment();" href="#" {{--style="pointer-events: none; color: #ccc;"--}} title="comment">Submit</a>
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                    </div>
                </form>
              </div>
...
@section('script')
    <script>
        ...
        function add_comment()
        {
            ...
            document.getElementById('add_comment').href += '/'+desc;
        }
        $('#records tr').click(function() {    
            ...
            document.getElementById('add_comment').href ="<?php echo url('/');?>/add_comment/"+user_id+"/"+lead_id;
        ...
        $(document).ready(function(){
            ...
            $('#filter').on("change",function(){
                ...
                var url = "<?php echo url('/');?>/filterJDLeadsInProgress/"+dataString;
                window.location.assign(url);
            })
        });
    </script>
