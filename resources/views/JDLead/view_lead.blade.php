                    ...
                    {{ csrf_field() }}
                        <div class="card-body">
                            ...
                            <input type="hidden" name="lead_id" id="lead_id" value="<?php echo $lead_details[0]['id'];?>">
                                    ...
                                    <?php 
                                        if($lead_details[0]['lead_status']=='Converted' OR $lead_details[0]['lead_status']=='Closed' OR $lead_details[0]['lead_status']=='Vendor Assigned' OR $lead_details[0]['lead_status']=='Order Generated' OR $lead_details[0]['lead_status']=='Delivery In Progress')
                                        {
                                    ?>
                                            <div class="row form-group">
                                                <div class="col-md-2">
                                                    ...
                                                    <table class="table table-bordered table-responsive" id="equipment_table">
                                                        ...
                                                        <tbody class="table-body">
                                                            <?php
                                                                ...
                                                                {
                                                                    $count++;
                                                                    $total = $total + $deposites[$i] + $offered_rents[$i] + $transports[$i];
                                                            ?>
                                                                    <tr id="{{$count}}">
                                                                        <td>{{$count}}</td>
