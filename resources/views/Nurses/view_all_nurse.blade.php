                                ...
                                <tbody>
                                    ...
                                    @foreach ($nurses_data as $nurse_data)
                                        ...
                                        <tr data-count="{{$count}}">
                                            <td>{{$count}}</td>
                                            <td>
                                                {{-- <a class="btn btn-success btn-sm btn-block" href="{{url('/')}}/view_nurse_details/{{$nurse_data['id']}}" role="button">Referral it</a>  --}}
                                                <a class="btn btn-primary btn-sm btn-block" href="{{url('/')}}/in_progress/{{$nurse_data['id']}}/{{session('user_id')}}" role="button">Progress it</a> 
                                                {{-- <a class="btn btn-danger btn-sm btn-block" href="{{url('/')}}/close/{{$nurse_data['id']}}/{{session('user_id')}}" role="button">Close</a>  --}}
