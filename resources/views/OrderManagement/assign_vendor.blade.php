                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{-- <a href="{{url('/')}}/assign_vendor_exp/{{$lead_details[0]['id']}}/{{$lead_details[0]['cust_id']}}" class="btn btn-primary" name="explode" id="explode">Explode</a> --}}
                                </div>
                            </div>
                            <hr>
                            @if ($errors->any())
                            ...
                            <div class="row ">
                                <div class="col table_records">
                                    <table id="records" class="table table-bordered table-responsive nowrap" style="width:100%; ">
                                        <thead>
                                            <tr>
                                                <th>Sr.No.</th>
                                        ...
                                        <tbody class="tbody">
                                            <?php
                                                ...
                                                { 
                                            ?>
                                            <tr class="rows <?php if($sale_rental[$i] == "Sale"){echo "table-info";}elseif($sale_rental[$i] == "Rental"){echo "table-success";}?>" data-count="{{$count}}" >
                                                <td>{{$i+1}}</td>
                                                ...
                                                <td>
                                                    @if(isset($del_date))
                                                        <span name="del_date[]" id="del_date{{$count}}" value="{{$del_date[$i]}}">{{$del_date[$i]}}</span></td>
                                                    @endif
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @if(isset($equipment_quantity))
                                                        ...
                                                        {{-- @if($equipment_quantity[$i]>1)
                                                            <button class="btn btn-primary btn-sm" type="button" name="diff_qty" id="{{$count}}" onclick="diff_qty_fun(this.id);" value="DiffQty">DiffQty</button>
                                                        @endif --}}
                                                    @endif
                                                </td>                                                
                                                ...
                                                <td>
                                                    ...
                                                    @if(isset($deposite_total))
                                                        <span name="deposite_total[]" id="deposite_total{{$count}}>" style="display: none;">{{$deposite_total[$i]}}</span>
                                                        <input type="hidden" name="deposite_total[]" id="deposite_total" value="{{$deposite_total[$i]}}">
                                                    @endif
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @if(isset($offered_rent_total[$i]))
                                                        <span name="offered_rent_total[]" id="offered_rent1_total{{$count}}">{{$offered_rent_total[$i]}}</span>
                                                        <input type="hidden" name="offered_rent_total[]" id="offered_rent_total{{$count}}" value="{{$offered_rent_total[$i]}}">
                                                    @endif
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @if(isset($transport))
                                                        <span name="transport[]" id="transport{{$count}}">{{$transport[$i]}}</span>
                                                        <input type="hidden" name="transport[]" id="transport{{$count}}" value="{{$transport[$i]}}">
                                                    @endif  
                                                </td>
                                            </tr>
                                            <?php
                    ...
                    success: function (data)
                    {
                        ...
                        for (var i=0; i <products.length; i++) 
                        {
                            for(var j=0; j <equipment_quantity[i]; j++)
                            {
                                ...
                                rows += "<td id='select_warehouse"+j+"'><select class='selectpicker' width='fit' title='Select Warehouse' name='warehouses[]' id='warehouses"+count+"' data-live-search='true' width='100%' required='true'><option value='' disabled>Select Vendor First</option></select><input type='hidden' name='vendor_product_id[]' id='vendor_product_id"+count+"'></td>";
                ...
                $.ajax({
                    ...
                    success: function (data)
                    {
                        ...
                        for (var i=0; i <products.length; i++) 
                        {
                            ...
                            rows += "<td id='select_warehouse"+i+"'><select class='selectpicker' width='fit' title='Select Warehouse' name='warehouses[]' id='warehouses"+count+"' data-live-search='true' width='100%' required='true'><option value='' disabled>Select Vendor First</option></select><input type='hidden' name='vendor_product_id[]' id='vendor_product_id"+count+"'></td>";
