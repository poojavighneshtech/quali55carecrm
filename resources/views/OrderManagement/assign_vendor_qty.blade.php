...
@extends('header_and_sidebar')
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <tr class="rows <?php if($sale_rental[$i] == "Sale"){echo "table-info";}elseif($sale_rental[$i] == "Rental"){echo "table-success";}?>" data-count="{{$count}}" >
                                                ...
                                                <td id='select_batch{{$i}}'>
                                                    ...
                                                    <select class="selectpicker" width="fit" title="Select Batch" name="batches[]" id="batches{{$count}}" data-live-search="                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        " width="100%" required="true">
    ...
    @section('script')
        <script>
            ...
            // $("#records").on('click', 'tbody tr', function() {
            //     var currentPage = table.page();
                
            //     //insert a test row
            //     countTable++;
            //     table.row.add([countTable, countTable, countTable, countTable, countTable]).draw();
                
            //     //move added row to desired index (here the row we clicked on)
            //     var index = table.row(this).index(),
            //         rowCountTable = table.data().length-1,
            //         insertedRow = table.row(rowCountTable).data(),
            //         tempRow;

            //     for (var i=rowCountTable;i>index;i--) {
            ...
            // });
            // function diff_qty_fun(id)
            // {
            //     var product_qty = $("#eq_quantity_hidden"+id).val();
            //     //alert('DiffQty: '+id+' Qty: '+product_qty);
            //     var qty = prompt("Diffrenticate Qty into",product_qty);
            //     if(qty != null)
            //     {
            //         alert('Differentiated Qty: '+qty);
            //     }
            // }
