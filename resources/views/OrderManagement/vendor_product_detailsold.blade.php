    ...
    @section('content')
        ...
        <div class="card" id="filter_card">
            ...
            <div class="card-body border-primary collapse" id="filter-collapse" aria-labelledby="headingTwo" data-parent="#filter_card">
                <form action="{{url('/')}}/order_detailstest" method="GET" id="all_order_form">
                    @csrf
                    <div class="row">
                        <div class="col-md-10">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="row form-group my-2">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <label for="product_name"><strong>Product Type:</strong></label>
                                                </div>
                                                <div class="col-md-7">
                                                    <select class="selectpicker form-control form-control-sm border" name="sale_rental" id="sale_rental">
                                                        <option value="All" @if(isset($filter_data['sale_rental'])) @if($filter_data['sale_rental'] == "All")selected @endif @endif>All</option>
                                                        <option value="Rental" @if(isset($filter_data['sale_rental'])) @if($filter_data['sale_rental'] == "Rental")selected @endif @endif>Rental</option>
                                                        <option value="Sale" @if(isset($filter_data['sale_rental'])) @if($filter_data['sale_rental'] == "Sale")selected @endif @endif>Sale</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="contact_no"><strong>Order ID :</strong></label>
                                                </div>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control form-control-sm" name="order_no"  id="order_no" placeholder="Order ID..."
                                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" 
                                                        value="@if(isset($filter_data['order_no'])){{$filter_data['order_no']}}@endif">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="row">
                                <div class="col-md">
                                    <a href="{{url('/')}}/order_detailstest" class="btn btn-outline-secondary btn-sm btn-block btn">Clear Filter</a>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col">
            ...
            <div class="table table-responsive jim-table-responsive table-sm">
                ...
                @php
                    ...
                    if(isset($filter_data['sale_rental'])){
                        $append_arr['sale_rental'] = $filter_data['sale_rental'];
                    }
                @endphp
        ...
        <div id="count_modal" class="modal modal-fade" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="table" class="table" style="overflow:scroll; height:400px;"></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
    ...
    @section('script')
        <script>
            ...
            $(".count").on("click",function(){
                ...
                let sale_rental = $("#sale_rental").val();
                ...
                {
                    let dataString = ({_token:"{{ csrf_token() }}",cust_name:""+cust_name,cust_no:""+cust_no,from_date:""+from_date,end_date:""+end_date,vdr_name:""+vdr_name,prod_name:""+prod_name,order_type:""+order_type,sale_rental:""+sale_rental,section:"vendor_rent_count"});
                    $.ajax({
                        type: "GET",
                ...
                {
                    let dataString = ({_token:"{{ csrf_token() }}",cust_name:""+cust_name,cust_no:""+cust_no,from_date:""+from_date,end_date:""+end_date,vdr_name:""+vdr_name,prod_name:""+prod_name,order_type:""+order_type,sale_rental:""+sale_rental,section:"order_rent_count"});
                    $.ajax({
                        type: "GET",
                        url: "{{url('/')}}/order_details_count",
                        data: dataString,
                ...
                {
                    let dataString = ({_token:"{{ csrf_token() }}",cust_name:""+cust_name,cust_no:""+cust_no,from_date:""+from_date,end_date:""+end_date,vdr_name:""+vdr_name,prod_name:""+prod_name,order_type:""+order_type,sale_rental:""+sale_rental,section:"order_deposite_count"});
                    $.ajax({
                        type: "GET",
                        url: "{{url('/')}}/order_details_count",
                        data: dataString,
                ...
                {
                    let dataString = ({_token:"{{ csrf_token() }}",cust_name:""+cust_name,cust_no:""+cust_no,from_date:""+from_date,end_date:""+end_date,vdr_name:""+vdr_name,prod_name:""+prod_name,order_type:""+order_type,sale_rental:""+sale_rental,section:"equipment_count"});
                    $.ajax({
                        type: "GET",
                        url: "{{url('/')}}/order_details_count",
                        data: dataString,
                    ...
                    success: function (data)
                    {
                        ...
                        if(images!=false){
                            ...
                            Object.keys(images).forEach(function(key){
                                            console.log("Key:", key, "Value:", images[key]);
