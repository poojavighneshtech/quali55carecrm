                            ...
                            <table class="table table-striped table-bordered table-responsive" id="records">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Visit Time</th>
                                        <th>Lab Name</th>
                                        <th>Blood Collection address</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($get_all_leads as $key=> $all_leads) 
                                        <tr>
                                            ...
                                            <td>{{$all_leads['test_name']}}</td>
                                            <td>{{$all_leads['visit_date']}}</td>
                                            <td>{{$all_leads['visit_time']}}</td>
                                            <td>{{$all_leads['lab_name']}}</td>
                                            <td>{{$all_leads['blood_collection_address']}}</td>
                                            <td>{{$all_leads['customer_price']}}</td>
