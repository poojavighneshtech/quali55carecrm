                        ...
                        <tbody>
                            @forelse($rows as $key=>$data)
                                <tr>
                                    ...
                                    <td class="text-nowrap" data-label="Renew Date">{{date('d-m-Y',strtotime($data->ren_start_date))}}</td>
                                    ...
                                    <td data-label="Due Months" class="text-nowrap">{{$orderMonthData[$key]['month_count']." ".$data->billing_unit}}</td>
                                    {{-- <td>
