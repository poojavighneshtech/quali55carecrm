            ...
            success: function (data)
            {
                ...
                Object.keys(data.orderProducts).forEach(function(key){
                    ...
                    row += "<tr id='trParent'>";
                        ...
                        row+="<td data-label='P. Qty'>"+data.orderProducts[key].product_qty+"</td>";
                        ...
                        if(data.orderProducts[key].customer_type == 'Corporate'){
                            row+="<td data-label='R. Qty class='text-nowrap'><a type='button' onclick='fetchdata("+data.orderProducts[key].order_details_id+");'>"+data.productMonthData[key].month_count+"</a></td>";
                        }else{
                            row+="<td data-label='R. Qty' class='text-nowrap'>"+data.productMonthData[key].month_count+"</td>";
                        }
                        row+="<td data-label='B.Period'>"+data.orderProducts[key].billing_unit+"</td>";
                        // row+="<td data-label='B.Period'>"+data.orderProducts[key].billing_unit+"</td>";
