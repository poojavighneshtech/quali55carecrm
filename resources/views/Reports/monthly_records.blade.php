                ...
                <div class="col-md-8  justify-content-start">
                    <h4>
                        ...
                        <select class="select selectpicker" name="headfyear" id="headfyear">
                            ...
                            <option value="{{url('/')}}/monthly_records?headfyear=2024-2025&city={{$month_data[0]['city']}}" @if(isset($month_data[0]) && $month_data[0]['headfyear'] == '2024-2025'){{'selected'}}@endif >2024-2025</option>
                            <option value="{{url('/')}}/monthly_records?headfyear=2025-2026&city={{$month_data[0]['city']}}" @if(isset($month_data[0]) && $month_data[0]['headfyear'] == '2025-2026'){{'selected'}}@endif >2025-2026</option>
                        </select>
