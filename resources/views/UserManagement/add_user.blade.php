            ...
            <div class="col-6">
                <div class="card o-hidden border-0 shadow-lg">
                    ...
                    <div class="card-header bg-primary text-white">
                        <h3 class="m-0 font-weight-bold"> Add New User</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="username" id="username" placeholder="Username" required="true" value="{{old('username')}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="password" id="password" aria-describedby="password_help" placeholder="Password" required="true" value="{{old('password')}}">
                                    <ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="email" class="form-control" name="email_id_user" id="email_id_user" placeholder="Email" required="true" value="{{old('email_id_user')}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="contact_no" id="contact_no" maxlength="10" oninput="numberOnly(this.id);" placeholder="Mobile Number" required="true" value="{{old('contact_no')}}">
                                </div>
                            </div> 
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="location_user" id="location_user" placeholder="Area" required="true" value="{{old('location_user')}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="user_city" id="user_city" placeholder="City" required="true" value="{{old('user_city')}}" list="userCity" required>
                            ...
                            <div class="col-md-8">
                                   <!-- Default switch -->
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="20" id="hot_lead" data-toggle="collapse" href="#hot_lead" aria-expanded="false" aria-controls="hot_lead">
                                        <label class="custom-control-label" for="hot_lead">Hot Leads Management</label>
                                    </div>
                                    <div class="collapse" id="hot_lead">
                                        <div class="card card-body">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="role_access[]" value="21" id="all_hot_leads">
                                                <label class="custom-control-label" for="all_hot_leads">Hot Leads</label>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="role_access[]" value="22" id="in_process_hot_leads">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="1" id="lead" data-toggle="collapse" href="#lead" aria-expanded="false" aria-controls="lead">
                                        <label class="custom-control-label" for="lead">Lead</label>
                                    </div>
                                    <div class="collapse" id="lead">
                                        <div class="card card-body">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="role_access[]" value="2" id="lead_mgmt">
                                                <label class="custom-control-label" for="lead_mgmt">Lead Management</label>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="role_access[]" value="3" id="referral_mgmt">
                                                <label class="custom-control-label" for="referral_mgmt">Referral Management</label>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="role_access[]" value="4" id="jd_lead_mgmt">
                                                <label class="custom-control-label" for="jd_lead_mgmt">JD Lead Management</label>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="role_access[]" value="16" id="nurses_data">
                                                <label class="custom-control-label" for="nurses_data">Referrer Management</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="40" id="other_service" data-toggle="collapse" href="#other_service" aria-expanded="false" aria-controls="other_service">
                                        <label class="custom-control-label" for="other_service">Other Services</label>
                                    </div>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="30" id="complaint_mgmt" data-toggle="collapse" href="#complaint_mgmt" aria-expanded="false" aria-controls="complaint_mgmt">
                                        <label class="custom-control-label" for="complaint_mgmt">Complaint Mgmt</label>
                                    </div>
                                    {{--vendor--}}
                                    <div class="custom-control custom-switch" >
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="5" id="vdr" data-toggle="collapse" href="#vdr" aria-expanded="false" aria-controls="vdr">
                                        <label class="custom-control-label" for="vdr">Vendor</label>
                                    </div>
                                    
                                    <div class="collapse" id="vdr">
                                        <div class="card card-body">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="role_access[]" value="6" id="vendor_mgmt">
                                                <label class="custom-control-label" for="vendor_mgmt">Vendor Management</label>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="role_access[]" value="7" id="vendor_inventory_mgmt">
                                    ...
                                    {{--Product mgmt--}}
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="8" id="product_mgmt" data-toggle="collapse" href="#product_mgmt" aria-expanded="false" aria-controls="product_mgmt">
                                        <label class="custom-control-label" for="product_mgmt">Product Management</label>
                                    </div>
                                    
                                    <div class="collapse" id="product_mgmt">
                                        <div class="card card-body">
                                            <div class="custom-control custom-switch custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="role_access[]" value="9" id="master_product_mgmt">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="17" id="order_mgmt">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="12" id="renewal_pickup">
                                        <label class="custom-control-label" for="renewal_pickup">Renewal and Pickup</label>
                                    </div>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="13" id="billing_payments">
                                        <label class="custom-control-label" for="billing_payments">Billing & Payments</label>
                                    </div>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="14" id="reports">
                                        <label class="custom-control-label" for="reports">Reports</label>
                                    </div>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="15" id="user_mgmt">
                                        <label class="custom-control-label" for="user_mgmt">User Management</label>
                                    </div>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="61" id="b2b_user">
                                        <label class="custom-control-label" for="b2b_user">B2B User</label>
                                    </div>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="60" id="dummy_invoices">
                                        <label class="custom-control-label" for="dummy_invoices">Dummy Invoices</label>
                                    </div>
