                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="role">
                                        @if(session('role')=='superuser')
                                            <option value="superuser" @if($user_details[0]['role']=='superuser') {{"selected"}} @endif>SuperUser</option>
                                            <option value="admin" @if($user_details[0]['role']=='admin') {{"selected"}} @endif>Admin</option>
                                            <option value="user" @if($user_details[0]['role']=='user') {{"selected"}} @endif>User</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                   <!-- Default switch -->
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="40" id="other_service" data-toggle="collapse" href="#other_service" aria-expanded="false" aria-controls="other_service" @if(in_array('40',$role_access)) {{"checked"}} @endif>
                                        <label class="custom-control-label" for="other_service">Other Services</label>
                                    </div>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="30" id="complaint_mgmt" data-toggle="collapse" href="#complaint_mgmt" aria-expanded="false" aria-controls="complaint_mgmt" @if(in_array('30',$role_access)) {{"checked"}} @endif>
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="61" id="b2b_user" @if(in_array('61',$role_access)) {{"checked"}} @endif>
                                        <label class="custom-control-label" for="b2b_user">B2B User</label>
                                    </div>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="role_access[]" value="60" id="dummy_invoices" @if(in_array('60',$role_access)) {{"checked"}} @endif>
