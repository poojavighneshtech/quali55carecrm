        ...
        {{ csrf_field() }}
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Pending Vendors Registration</h6>
                </div>
                <div class="card-body">
                                ...
                                @if (isset($vendor_details) and $vendor_details!='null')
                                    ...
                                    <tr>
                                        @if($vendor_detail['authentication_status']=='Pending')
                                            ...
                                            <td value='{{$vendor_detail['of_primary_contact_1']}}' data-label="Mobile No">{{$vendor_detail['of_primary_contact_1']}}</td>
                                            ...
                                            <td data-label="Action">
                                                <a href = '{{url('/')}}/vendor_details/{{$vendor_detail['id']}}' name='' class='btn btn-primary'>View Details</a><br>
                                                <a href = '{{url('/')}}/vendor_details/{{$vendor_detail['id']}}' name='' class='btn btn-danger'>Delete</a>
                                            </td>
                                        @endif                                                
                                    </tr>
                                    @endforeach                                    
