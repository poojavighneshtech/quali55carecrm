        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Rejected Vendors Registration</h6>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @if (isset($vendor_details) and $vendor_details!='null')
                                    @foreach ($vendor_details as $vendor_detail)
                                       <tr>
                                            @if($vendor_detail['authentication_status']=='Rejected')
                                               ...
                                               <td data-label="Status" value='{{$vendor_detail['authentication_status']}}'>{{$vendor_detail['authentication_status']}}</td>
