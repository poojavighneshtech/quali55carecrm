...
<body id="page-top">
    ...
    <div id="">
                                ...
                                <div class="collapse LeadManagement @if(session('name')!=null && session('name')=='LeadManagement'){{"show"}} @endif" id="LeadManagement" aria-labelledby="LeadManagement" data-parent="#accordion">
                                    <div class=" card bg-white py-2 collapse-inner rounded">
                                        ...
                                        @if(in_array(session('user_id'),config('app.it_department')))
                                            <a class="collapse-item" href="{{route('customer-master.index')}}">Customer Master</b></a>
                                        @endif
        ...
        @section('CRM_Leads')
            <li class="nav-item">
                <a class="nav-link nav-link-hide collapsed" href="#" id="CRM_Leads" data-toggle="collapse" data-target="#CRM_LeadsCollapse"
                    aria-expanded="true" aria-controls="CRM_LeadsCollapse"  onClick="myFunction(this.id);">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>CRM Leads</span>
                </a>
                <div id="CRM_LeadsCollapse" class="collapse CRM_Leads" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('/')}}/viewCRMAllLeads">View All Leads</a>
                        <a class="collapse-item" href="{{url('/')}}/createLeads">Create Leads</a>
                        <a class="collapse-item" href="{{url('/')}}/viewWebsiteOrder">View Website Order</a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow fixed-top">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="container container-fluid d-none d-md-block mt-4">
                            ...
                            <a class="btn text-nowrap btn-primary btn-sm form-control" style="margin-top: 20px;" href="{{route('viewAllReferrals')}}">
                                <span>REF</span> <span id="viewAllReferrals" class="badge badge-light">0</span>
                            </a>
                            <a class="btn text-nowrap btn-primary btn-sm form-control ml-2" style="margin-top: 20px;" href="{{route('order-delivery-all',['filter_order_status'=>'Converted'])}}">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url : "{{url('/')}}/referralsCount",
                type : "GET",
                success : function(referrals_count)
                {
                    // console.log(lead_count);
                    $("#viewAllReferrals").text(referrals_count);
                }
            });
            $('#records').DataTable();
            $.ajax({
