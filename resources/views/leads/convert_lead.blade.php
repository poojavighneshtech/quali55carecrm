        ...
        <div class="card-body"><!--style="min-height: 0; max-height: 5; overflow-y: scroll;"-->
            ...
            {{ csrf_field() }}
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-3">
                        <input type="date" class="form-control" name="converted_date" id="converted_date" value="{{date('Y-m-d')}}">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-4">                                            
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-8">
                                <input type="text" class="form-control" <?php echo"value='".$lead_details[0]['patient_name']."'";?> id="patient_name" name="patient_name" placeholder="Patient Name">
                ...
                <div class="row form group">
                    <div class="col-md-4 form-group patient_document">
                        {{-- <div class="col-md-4"> --}}
                            <label for="patient_doc_id_no">Document No.</label>
                        {{-- </div>
                        <div class="col-md-8"> --}}
                            <input type="text" class="form-control" name="patient_doc_id_no" id="patient_doc_id_no">
                        {{-- </div> --}}
                    </div>
                    <div class="col-md-4 form-group patient_document">
                        {{-- <div class="col-md-4"> --}}
                    ...
                    <div class="col-md-4 form-group patient_document_uploaded">
                        {{-- <div class="col-md-4"> --}}
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                    <select class="select selectpicker form-control form-control-sm" title="Select Corporation" name="corp_master" id="corp_master" required="true">
                                        @foreach($corp_masters as $key=>$master)
                                            <option value="{{$master['id']}}">{{$master['corp_name']}}</option>
                                        @endforeach
                        ...
                        @endif
                <div id="corporate_contacts" class="row form-group" style="@if($lead_details[0]['customer_type'] == 'Corporate') display:block; @else display:none;@endif">
                    <div class="col-md-3">
                        <label for="contact_person_1_name">Corporate Contact Person 1</label>
                        <input type="text" class="form-control" id="contact_person_1_name" <?php if(isset($lead_details[0]['contact_person_1_name'])){echo"value='".$lead_details[0]['contact_person_1_name']."' disabled";}?> 
                            name="contact_person_1_name" placeholder="First Contact Person Name" @if($lead_details[0]['customer_type'] == 'Corporate') required @endif>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="contact_person_1_no" <?php if(isset($lead_details[0]['contact_person_1_no'])){echo"value='".$lead_details[0]['contact_person_1_no']."' disabled";}?> name="contact_person_1_no" 
                            placeholder="First Contact Person Number" oninput="numberOnly(this.id);" maxlength="10" @if($lead_details[0]['customer_type'] == 'Corporate') required @endif>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-8 radio-group">
                                <input type="radio" name="cust_type" id="registered" value="registered"><label for="registered" @if($lead_details[0]['lead_source'] == 'B2B Cust'){{'selected'}}@endif> Registered</label>&emsp;
                        ...
                        <div class="row form-group" id="gst_no_row" @if($lead_details[0]['lead_source'] == 'B2B Cust'){{''}}@else{{'style="display:none"'}}@endif>
                    <div class="col-md-4">
                        ...
                        <tbody class="table-body">
                            <?php
                                ...
                                {   
                                    ...
                                    if(isset($lead_details[0]['equipmeny_qty']))
                                    {
                                        $qtys = json_decode($lead_details[0]['equipmeny_qty']);
                                    }
                            ...
                            ?>
                                        <tr id="{{$count}}">
                                            ...
                                            <td data-label="Sales / Rental">
                                                <input type="radio" name="sale_rental[]{{$count}}" id="sale{{$count}}" value="Sale"><label for="sale{{$count}}">Sale</label>&emsp;
                                                <input type="radio" name="sale_rental[]{{$count}}" id="rental{{$count}}" checked value="Rental"><label for="rental{{$count}}">Rental</label>
                                            </td>
                                            <td data-label="Delivery Date" width="-10%">
                                                <input type="date" class="form-control form-control-sm date" width="50px" name="DelDate[]" id="DelDate{{$count}}" value="<?php echo date('Y-m-d');?>">
                                            </td>
                                            <td data-label="Equipment Name">
                                                {{$product['product_name']}}
                                                <input type="hidden" id="equipments{{$count}}" name="equipments[]" value="{{$product['id']}}">
                                            </td>
                                            <td data-label="Qty">
                                                <input type="text" name="qty[]" id="qty{{$count}}" class="form-control form-control-sm" value="<?php echo "1";?>">
                                            </td>
                                            <td data-label="Month">
                                                <input type="text" name="month[]" id="month{{$count}}" class="form-control form-control-sm" value="<?php echo "1";?>">
                                            </td>
                                            <td data-label="Deposit">
                                                <span id="deposite{{$count}}"><?php echo $product['product_deposite'];?></span>
                                                <input type="hidden" name="prod_deposite[]" id="prod_deposite{{$count}}" value="{{$product['product_deposite']}}">                                                                    
                                                <input type="hidden" name="min_depo[]" id="min_depo{{$count}}" value="{{$product['product_deposite']-($product['product_deposite']*$product['min_rent_percentage'])/100}}">
                                            </td>
                                            <td data-label="Offered Deposit">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <input type="checkbox" name="same_as_deposite[]" id="same_as_deposite{{$count}}">
                                                    </div>
                                                    <div class="col-md-10">
                                                        <input type="text" name="offered_deposite[]" id="offered_deposite{{$count}}" class="form-control form-control-sm" value="" required>
                                                    </div>
                                                </div>
                                                <span id="offered_deposite_total_span{{$count}}" style="display: none;">0</span>
                                                <input type="hidden" name="offered_deposite_total[]" id="offered_deposite_total{{$count}}" class="form-control form-control-sm" value="0">
                                            </td>
                                            <td data-label="Rent/Sale Price">
                                                <span id="rent_td{{$count}}">{{$product['product_rent']}}</span>
                                                <input type="hidden" name="rent[]" id="rent{{$count}}" value="{{$product['product_rent']}}">
                                            </td>
                                            <td data-label="Offered Rent/Sale Price">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <input type="checkbox" name="same_as_rent[]" id="same_as_rent{{$count}}">
                                                    </div>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control form-control-sm" id="offered_rent{{$count}}" name="offered_rent[]" value="" required>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="min_rent[]" id="min_rent{{$count}}" value="{{$product['product_rent']-($product['product_rent']*$product['min_rent_percentage'])/100}}">
                                            </td>
                                            <td data-label="Total Offered Rent/Sale Price">
                                                <span id="offered_rent_total_span{{$count}}">0</span>
                                                <input type="hidden" class="form-control form-control-sm" id="offered_rent_total{{$count}}" name="offered_rent_total[]" value="0">
                                            </td>
                                            <td data-label="Transport">
                                                <input type="text" class="form-control form-control-sm" id="transport{{$count}}" name="transport[]" value="" required>
                                            </td>
                                            <td data-label="Discount">
                                                <span id="discount{{$count}}">0(0%)</span>
                                                <input type="hidden" name="discount_hidden[]" id="discount_hidden{{$count}}">
                                            </td>
                                            <td data-label="Remove">
                                                <button type="button" class="btn btn-danger" id="{{$count}}" name="remove" onclick="remove(this.id);"><i class="fas fa-trash-alt"></i></button>
                                            </td>
                                        </tr>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" class="form-control" <?php echo"value='".$lead_details[0]['pincode']."'";?> name="pincode" id="pincode" placeholder="Pincode*" maxlength="6" required>
                                    </div>
                                    {{--Converted at date--}}
                                    <input type="hidden" name="converted_at" value="{{$lead_details[0]['converted_at']}}">
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="email" class="form-control" <?php echo"value='".$lead_details[0]['email_id']."'";?> name="email" id="email" placeholder="Email*"required="true">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" class="form-control"  name="prmt_pincode" id="prmt_pincode" placeholder="Pincode*" maxlength="6">
                                    </div>
                                </div>
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <center><input type="checkbox" name="same_address" id="same_address" required> <label for="same_address" style="color:tomato">is address verified?</label></center>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-4">
        ...
        <script>
            ...
            function add_product()
            {
                ...
                var row = "<tr id='"+count+"'>";
                    ...
                    row += '<td><select class="selectpicker form-control" data-width="fit" id="equipments'+count+'" title="Select Products From Dropdown" name="equipments[]" data-size="5" data-live-search="true" required><?php foreach($products_details as $product){ echo "<option value=".$product['id'].">".$product['product_name']."</option>";}?></select></td>';
            ...
            $(".table-body").on('click',"tr",function()
            {
                ...
                for(var i = 1; i <= count1; i++)
                {
                    ...
                    // document.getElementById('offered_deposite_total_span'+i).innerHTML = total_offered_deposit_pre;
