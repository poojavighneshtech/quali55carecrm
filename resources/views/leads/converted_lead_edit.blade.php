                            ...
                            <div class="card-body"><!--style="min-height: 0; max-height: 5; overflow-y: scroll;"-->
                                ...
                                {{ csrf_field() }}
                                            ...
                                            <tbody class="table-body">
                                                <?php
                                                    ...
                                                    {   
                                                        ...
                                                        if(isset($lead_details[0]['billing_period']))
                                                        {
                                                            $billing_period = json_decode($lead_details[0]['billing_period']);
                                                        }
                                                        if(isset($lead_details[0]['billing_unit']))
                                                        {
                                                            $billing_unit = json_decode($lead_details[0]['billing_unit']);
                                                        }
                                                        ...
                                                        ?>
                                                                <tr id="{{$count}}">
                                                                    ...
                                                                    <td data-label="Billing Period"><input type="number" name="billingPeriod[]" id="billingPeriod{{$count}}" class="form-control form-control-sm" value="@if(isset($billing_period)){{$billing_period[$i]}}@else{{"1"}}@endif"></td>
                                                                    <td data-label="Billing Unit">
                                                                        <select name="billingUnit[]" id="billingUnit{{$count}}" class="select selectpicker">
                                                                            <option value="Days" @if(isset($billing_unit))@if($billing_unit[$i] == 'Days'){{"selected"}}@endif @endif>Days</option>
                                                                            <option value="Week" @if(isset($billing_unit))@if($billing_unit[$i] == 'Week'){{"selected"}}@endif @endif>Week</option>
                                                                            <option value="Half Month" @if(isset($billing_unit))@if($billing_unit[$i] == 'Half Month'){{"selected"}}@endif @endif>Half Month</option>
                                                                            <option value="Month" @if(isset($billing_unit))@if($billing_unit[$i] == 'Month'){{"selected"}}@endif @else{{"selected"}}@endif>Month</option>
                                                                        </select>
                                                                        <span class="text-danger" @if($billing_unit[$i] == 'Month'){{"style=display:none;"}}@endif id="infomsg1{{$count}}"><strong>Enter offered rent per {{$billing_unit[$i]}}</strong></span>
                                                                    </td>
                                                                    ...
                                                                    <td data-label="Offered Rent/Sale Price"><div class="row"><div class="col-md-3"><input type="checkbox" name="same_as_rent[]" id="same_as_rent{{$count}}" @if(isset($offered_rents[$i])) @if($offered_rents[$i] == $product['product_rent']) {{"checked"}} @endif @endif></div><div class="col-md-9"><input type="text" class="form-control form-control-sm" id="offered_rent{{$count}}" name="offered_rent[]" value="@if(isset($offered_rents)){{$offered_rents[$i]}}@else{{""}}@endif" required></div></div><input type="hidden" name="min_rent[]" id="min_rent{{$count}}" value="{{$product['product_rent']-($product['product_rent']*$product['min_rent_percentage'])/100}}">
                                                                        <span class="text-danger" @if($billing_unit[$i] == 'Month'){{"style=display:none;"}}@endif id="infomsg2{{$count}}"><strong>Enter offered rent per {{$billing_unit[$i]}}</strong></span></td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <center>
                                                <button type="button" class="btn btn-primary" name="add_new_product" onclick="add_product();" value="add_new_product" disabled>Add Equipment</button>
                                            </center>
                                        </div>
                                    </div>
                                    <br>
    ...
    <script>
        ...
        function add_product()
        {
            ...
            var row = "<tr id='"+count+"'>";
                ...
                row += '<td data-label="Billing Period"><input type="number" name="billingPeriod[]" id="billingPeriod'+count+'" class="form-control form-control-sm" value="1"></td>';
                row += '<td data-label="Billing Unit">';
                    row += '<select name="billingUnit[]" id="billingUnit'+count+'" class="select selectpicker">';
                        row += '<option value="Days">Days</option>';
                        row += '<option value="Week">Week</option>';
                        row += '<option value="Half Month">Half Month</option>';
            ...
            $("#billingUnit"+count).selectpicker();
        ...
        $(".table-body").on('click',"tr",function()
        {
            ...
            $('#billingPeriod'+count).on('change',function(){
                var qty = parseInt($('#qty'+count).val());
                var month = parseInt($('#month'+count).val());
                
                var billingUnit = $('#billingUnit'+count).val();
                var billingPeriod = $('#billingPeriod'+count).val();
                ...
                // if($('#billingUnit'+count).val() == 'Days'){
                //     var total_rent = rent*qty*1;    
                //     var total_deposite = deposite*qty*1;
                // }else{
                    if(sale_rental == 'Rental'){
                        var total_rent = rent*qty*billingPeriod;    
                        var total_deposite = deposite*qty*billingPeriod;
                    }else{
                        var total_rent = rent*qty;    
                        var total_deposite = deposite*qty;
                    }
            ...
            $('#billingUnit'+count).on('change',function(){
                var qty = parseInt($('#qty'+count).val());
                var month = parseInt($('#month'+count).val());
                ...
                console.log(billingUnit);
                if(billingUnit != "Month"){
                    $("#infomsg1"+count).html("<strong>Enter offered rent per "+billingUnit+"</strong>");
                    $("#infomsg2"+count).html("<strong>Enter offered rent per "+billingUnit+"</strong>");
                    $("#infomsg1"+count).show();
                    $("#infomsg2"+count).show();
                }else{
                    $("#infomsg1"+count).hide();
            ...
            for(var i = 1; i <= count1; i++)
            {
                ...
                var billingUnit = $('#billingUnit'+i).val();
                var billingPeriod = $('#billingPeriod'+i).val();
                ...
                if(billingUnit == undefined || billingUnit == null)
                {
                    billingUnit = "Month";
                    interval = 1;
                }else{
                ...
                if(sale_rental == "Rental")
                {
                    var total_offered_rent_pre = parseInt(qty)*parseInt(interval)*parseInt(offered_rent);
                }
                else if(sale_rental == "Sale")
                {
