                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    @if ($errors->has('patient_gender'))
                                        <span class="text-danger">{{ $errors->first('patient_gender') }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
