                    ...
                    <div class="col-md-10">
                        <div class="card">
                            ...
                            <div class="card-body"><!--style="min-height: 0; max-height: 5; overflow-y: scroll;"-->
                                <form class="form" method="POST" action="<?php echo url('/');?>/update_lead">
                                {{ csrf_field() }}
    ...
    <script>
        ...
        function add_product()
        {
            ...
            var row = "<tr id='"+count+"'>";
                ...
                row += "<td><span id='offered_deposite_total_span"+count+"'>0</span><input type='hidden' name='offered_deposite_total[]' class='form-control' id='offered_deposite_total"+count+"' value='0'></td>";
