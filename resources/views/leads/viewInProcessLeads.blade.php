        ...
        <div class="leads">
            ...
            <div class="card">
                <div class="card-header"  style="background-color: #4a6fdc; color: white;" >
                    <center>In Process Leads</center>
                </div> 
                <div class="card-body">
                        {{-- <center>
                    ...
                    <form class="form" method="post" action="<?php echo url('/');?>/viewInProcessLeads">
                        {{csrf_field()}}
                        {{-- <div class="row">
                            <div class="col-md-6">
                                <div class="row">
        ...
        $(document).ready(function(){
            ...
            $('#export').on('click', function(){
                $('<table>').append(table.$('tr').clone()).table2excel({
                    //exclude: ".excludeThisClass",
                    //name: "abc",
                    filename: "AllInProcessLeads-{{date('d-m-Y')}}"
                });
            });
            ...
            $('#filter').on("change",function(){
                ...
                var url = "<?php echo url('/');?>/filterInprocessLeads/"+dataString;
                window.location.assign(url);
        });
